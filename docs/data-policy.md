...
The authoritative policy is in [the README](../README.md#4-sharing-and-privacy-rules). The development stack does not yet expose workload-data mutation routes; the policies below govern the journeys added from Phase 2 onward.
