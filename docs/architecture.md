...
Backend authorization and storage belong in backend-core. API handlers and job handlers are separate entry points. Automated observations and human manager/HR decisions remain separate records and permissions. No product features or cloud resources are implemented by this scaffold.
